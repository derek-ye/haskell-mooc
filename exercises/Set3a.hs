...
firstHalf str = take midpointIndex str where midpointIndex = ceiling $ fromIntegral (length str) / 2

palindrome :: String -> Bool
palindrome str = (take midpointIndex str) == (take midpointIndex $ reverse str)
...
capitalize s = unwords $ map capitalizeFirstLetter $ words s
